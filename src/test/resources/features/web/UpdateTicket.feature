...
# создание тикета
    ...
    И ввести в поле "Title" значение "тест1кукумбер"
    И выбрать элемент "Django Helpdesk" в выпадающем списке "Queue"
    И ввести в поле "Email" значение "a@mail.ru"
...
#   прикрепление файла к тикету
    ...
    Тогда ввести в поле "Строка поиска" значение "тест1кукумбер"
    ...
    И на странице присутствует текст "a@mail.ru"
